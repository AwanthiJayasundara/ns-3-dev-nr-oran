...
static std::string s_trafficTraceFile = "results/nr/nr-traffic-trace.tr";
static std::string s_positionTraceFile = "results/nr/nr-position-trace.tr";
static std::string s_handoverTraceFile = "results/nr/nr-handover-trace.tr";
static std::string ns3_dir = "results/nr/";
...
main(int argc, char* argv[])
{
    ...
    std::string dbFileName = "oran-repository-nr-tn.db";
