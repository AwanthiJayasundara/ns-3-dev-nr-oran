 ...
 *
 * \code{.unparsed}
 * ./ns3 run "oran-nr-uav-load-aware-rsrp-handover-example --PrintHelp"
 * \endcode
 *
...
main(int argc, char* argv[])
{
    ...
    uint32_t maxUesPerCell = 3; // ORAN LM parameter: maximum number of UEs per cell (for load-aware handover decisions)
