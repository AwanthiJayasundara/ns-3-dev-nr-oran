...
#ifndef ORAN_LM_NR_2_NR_TORCH_HANDOVER
#define ORAN_LM_NR_2_NR_TORCH_HANDOVER
 ...
 * an NR cell to another based on a PyTorch ML model.
 */
class OranLmNr2NrTorchHandover : public OranLm
{
  protected:
    /**
  ...
  public:
    /**
     * Gets the TypeId of the OranLmNr2NrTorchHandover class.
     *
     * @return The TypeId.
     */
    static TypeId GetTypeId();
    /**
     * Constructor of the OranLmNr2NrTorchHandover class.
     */
    OranLmNr2NrTorchHandover();
    /**
     * Destructor of the OranLmNr2NrTorchHandover class.
     */
    ~OranLmNr2NrTorchHandover() override;
    /**
     * Runs the logic specific for this Logic Module. This will retrieve the
     * location of all NR UEs and eNBs and the application loss for all UEs,
  ...
  private:
     ...
     */
    std::vector<OranLmNr2NrTorchHandover::UeInfo> GetUeInfos(Ptr<OranDataRepository> data) const;
    /**
     ...
     */
    std::vector<OranLmNr2NrTorchHandover::GnbInfo> GetGnbInfos(
     ...
     * @param gnbInfos A vector with the eNB information.
     *
...
}; // class OranLmNr2NrTorchHandover

} // namespace ns3

#endif // ORAN_LM_NR_2_NR_TORCH_HANDOVER
